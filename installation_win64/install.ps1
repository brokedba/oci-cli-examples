...
$PythonVersionToInstall = "3.10.10"    # version of Python to install if none exists
$MinValidPython3Version = "3.10.0"    # minimum required version of Python 3 on system
